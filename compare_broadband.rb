...
get '/compare' do
  ...
  @wireless1 = BroadbandMap.wireless(:data_version => 'fall2010', :latitude => @location1['lat'].to_s, :longitude => @location1['lng'].to_s)
  @wireless2 = BroadbandMap.wireless(:data_version => 'fall2010', :latitude => @location2['lat'].to_s, :longitude => @location2['lng'].to_s)
  erb :compare
end
